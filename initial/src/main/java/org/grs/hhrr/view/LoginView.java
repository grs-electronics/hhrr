...
import org.grs.hhrr.utils.PasswordValidator;
	...
	public LoginView() {	
	 ...
	 private Component buildLoginForm() {
	    ...
	    private Component buildFields() {
	        ...
	        username.addValidator(new EmailValidator("Dirección de correo no válida"));
	    ...
	    private Component buildLabels() {
	        ...
	        Label title = new Label("HHRR GRS Electronics");
